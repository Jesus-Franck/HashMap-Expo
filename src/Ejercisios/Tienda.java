...
public class Tienda {
    public static void main(String[] args) {
        ...
        // 1. TODO: Agrega los productos con una cantidad inicial (ej: 10 unidades cada
        // uno)
        inventario.put("Memoria RAM", 10);
        inventario.put("Disco Duro", 10);
        inventario.put("Tarjeta Gráfica", 10);

        // 2. TODO: Simula una venta de 'Memoria RAM' (Réstale 1 al valor actual)
        inventario.put("Memoria RAM", inventario.get("Memoria RAM") - 1);

        // 3. TODO: Verifica si existe el producto 'Monitor'.
